...
int CAN_CAL_4 = 0;
int over = 0;
#define CAN_CON (done == 4)
int CAL_TIMES = 0;  // calculate times
...
void T_matmul_forward_1()
{
    while(over == 0)
    {
        ...
        // printf("Thread1 is running on CPU %d\n", sched_getcpu());
        CAN_CAL_1 = 0;
        mutex_lock(&lk);
        done++;
        // if(CAN_CON)
...
void T_matmul_forward_2()
{
    while(over == 0)
    {
        ...
        // printf("Thread2 is running on CPU %d\n", sched_getcpu());
        CAN_CAL_2 = 0;
        mutex_lock(&lk);
        done++;
        // if(CAN_CON)
...
void T_matmul_forward_3()
{
    while(over == 0)
    {
        ...
        // printf("Thread3 is running on CPU %d\n", sched_getcpu());
        CAN_CAL_3 = 0;
        mutex_lock(&lk);
        done++;
        // if(CAN_CON)
...
void T_matmul_forward_4()
{
    while(over == 0)
    {
        ...
        // printf("Thread4 is running on CPU %d\n", sched_getcpu());
        CAN_CAL_4 = 0;
        mutex_lock(&lk);
        done++;
        // if(CAN_CON)
...
int main(int argc, char** argv) {
    ...
    create(T_matmul_forward_1);
    create(T_matmul_forward_2);
    create(T_matmul_forward_3);
    create(T_matmul_forward_4);
